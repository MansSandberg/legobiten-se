    ...
    <>
      ...
      <section>
        ...
        <p>
          ...
          projekt med en enkel idé eller ett konkret behov och blir samtidigt
          ett sätt att lära mig något nytt.
        </p>
        <br />
        <p>
          På den här sidan har jag samlat några av de projekt som följt mig
          genom åren och som tillsammans berättar hur ett intresse för LEGO och
        ...
        <p>
          ...
          fascinerade mig också tidigt och jag ville lära mig programmera, men
          jag visste inte riktigt var jag skulle börja. <br />
          Vändpunkten kom när jag köpte en datortidning under en resa till
          Örebro. På den medföljande CD-skivan fanns olika gratisprogram som jag
          började experimentera med. <br />
        ...
        <p>
          Under en period lånade jag nästan alla programmeringsböcker som fanns
          på biblioteket. Jag försökte lära mig flera olika språk, men fastnade
          ofta redan innan jag hade skrivit första raden kod. Många böcker
          utgick från att man redan visste vilken utvecklingsmiljö man skulle
          använda och hur man installerade den. För mig blev det en onödigt hög
          tröskel. <br />
        ...
        <VerticalTimeline layout="1-column-left" lineColor="rgb(33, 150, 243)">
          ...
          >
            ...
            <p>
              ...
              skriva &lt;p&gt;-taggar och lärde mig skriva &amp;aring; för att
              få bokstaven å att visas.
            </p>
          </VerticalTimelineElement>
          ...
          >
            ...
            <p>
              ...
              men jag ville lära mig mer om hur man gjorde det själv från
              grunden. <br />
              Därför skapade jag en parallell hemsida, på engelska, som jag
              skrev helt från grunden med HTML, CSS och lite JavaScript. Jag
              använde mig av One.com som webbhotell och FTP för att ladda upp
          ...
          >
            ...
            <p>
              ...
              MySQL och C#. <br />
              Jag tog med mig de kunskaperna och byggde om Legoforever.com med
              en modernare layout baserad på div-element och CSS i stället för
              HTML-tabeller.
            </p>
            <p>
              ...
              <br />
              Det tyckte jag var roligt och köpte sen en egen Raspberry Pi som
          ...
          >
            ...
            <p>
              Några år senare kände jag mig så bekväm med att koda hemsidan
              själv att jag avvecklade Legoforever.com och flyttade Legobiten
              till en egen-kodad sida, också den på One.com. <br />
              Här tog jag mina kunskaper från gymnasiet och skrev om hela
              hemsidan med PHP och skapade en databas med MySQL som gick att
          ...
          >
            ...
            <p>
              På högskolan byggde jag vidare på grunden från gymnasiet och fick
              en bredare förståelse för mjukvaruutveckling. <br />
              Jag läste bland annat kurser inom objektorienterad programmering,
              databaser, nätverk, mobilutveckling och webbutveckling.
            </p>
            <p>
              Det var här jag först kom i kontakt med Node.js, Express och
              Python. <br />
              Node.js och Express använde jag senare när jag byggde den första
              versionen av DesignBySandberg.se, medan Python har blivit ett
              språk jag återvänt till i flera senare hobbyprojekt, bland annat
          ...
          >
            ...
            <p>
              ...
              Millennium Falcon #75192. Det var Legos då största set någonsin
              och den var svår att få tag på. Det var inte alltid den gick att
            ...
            <p>
              ...
              Facebook-gruppen skrev att Millennium Falcon hade kommit in i
              lager. Jag hade inte fått något mejl. När jag kom hem visade det
              sig att vår router tappat internetuppkopplingen och att Raspberry
              Pi:n därför inte kunnat köra skriptet. Det blev min första riktiga
              lärdom om att även infrastrukturen måste fungera.
            </p>
          </VerticalTimelineElement>
          ...
          >
            ...
            <p>
              ...
              Högskolan och använde mig av den kunskapen för att bygga en
              backend i Node.js med Express. Jag skapade unika adresser som
              dirigerade användarna till Google Drive-mapparna där lotterna
              fanns. HTML-filerna lade jag också bakom egna routes. Jag hostade
              hemsidan på AWS Elastic Beanstalk.
            </p>
          ...
          >
            ...
            <p>
              Första versionen fungerade bra, men efter några år blev den svår
              att underhålla. Varje ny säsong krävde nya bakgrundsbilder, nya
              SVG-ytor och fler routes.
            </p>

            <p>
              Jag har genom mitt jobb på Jordbruksverket lärt mig koda Angular
              för frontend och tänkte att det skulle passa att bygga hemsidan i
              det. Då skulle vi kunna få återanvändbara komponenter som vi kan
              använda för att lägga till nya lotter nästkommande år. <br />
              Deployen blev också lite smidigare. Den ligger fortfarande på AWS,
              men nu i en S3-Bucket.
            </p>

            <p>
              Genom åren har vi fått feedback från användarna i
              Facebook-grupperna där de efterfrågat möjligheten att skriva ut
              flera lotter med olika siffror, så att varje barn kan få en unik
              lott. Det implementerade jag i den nya versionen som fyller i
              siffror och vinster dynamiskt. <br />
