  ...
  return (
    <>
      ...
      <section className="kontakt">
        <h2>Kontakta mig</h2>
        <p>
          Har du frågor om mina projekt eller vill komma i kontakt med mig? Du
          når mig enklast via e-post eller LinkedIn.
        </p>
        <dl className="kontakt-list">
          ...
          <div className="kontakt-item">
            <dt>E-post</dt>
            <dd>
              <a href="mailto:hej@månssandberg.se">
                hej@månssandberg.se <HiMail />
              </a>
            </dd>
          </div>
          ...
          <div className="kontakt-item">
            <dt>Ort</dt>
            <dd>Nässjö - Öppen för distans- och hybridarbete.</dd>
          </div>
        </dl>
      </section>
    </>
