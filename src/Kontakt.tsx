...
function Kontakt() {
  return (
    <section className="kontakt">
      <h2>Kontakta mig</h2>
      <p>
        Har du frågor om mina projekt eller vill komma i kontakt med mig? Du når mig enklast via e-post eller LinkedIn.
      </p>
      <dl className="kontakt-list">
        <div className="kontakt-item">
          ...
          <dd>
            <a
              href="https://www.linkedin.com/in/m%C3%A5ns-sandberg-199294138/"
              target="_blank"
            ...
            >
              ...
              <span>Måns Sandberg<HiExternalLink /></span>
            </a>
          </dd>
        </div>
        ...
        <div className="kontakt-item">
          ...
          <dd>
            <a
              href="https://github.com/MansSandberg"
              target="_blank"
              rel="noopener noreferrer"
              aria-label="GitHub"
            >
              ...
              <span>GitHub <HiExternalLink /></span>
            </a>
          </dd>
        </div>
        ...
        <div className="kontakt-item">
          <dt>E-post</dt>
          <dd><a href="mailto:info@legobiten.se">info@legobiten.se <HiMail /></a></dd>
        </div>

        <div className="kontakt-item">
          <dt>Ort</dt>
          <dd>
            Nässjö - Öppen för distans- och hybridarbete.
          </dd>
        </div>
      </dl>
    </section>
