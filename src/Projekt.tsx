      ...
      <section>
        ...
        <div className="projekt-grid">
          ...
          <ProjektItem
            ...
            solution={
              "Jag utvecklade en app där hon kunde ladda upp incheckningar längs vägen, som alla med länken kunde följa. " +
          ...
          <ProjektItem
            ...
            background={
              "En av de podcasts jag följer är Kafferepet. Varje avsnitt följer samma struktur. De läser upp 9 historier i varje avsnitt. Arkivet med avsnitt är ganska stort och vill man lyssna om en historia gäller det att veta vilket avsnitt det lästes upp i."
            }
            solution={
          ...
          <ProjektItem
            ...
            background={
              "Jag har haft behovet av att göra kontinuerliga mätningar av hastigheten på mitt bredband hemma för att ha underlag att avgöra om uppkopplingen har varit stabil och om den har nått upp i de hastigheter som utlovats."
            }
            solution={
            ...
            lessons={
              "För att ladda upp till Google Cloud behövde jag läsa på om deras API och skapa nycklar för att koden skulle komma åt min Google Drive-mapp." +
